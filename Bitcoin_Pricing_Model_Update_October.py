...
# training_set_scaled = training_set / 10e4
...
# new scaling method again
inputs_2 = inputs_2 / 10e4

#storing test data as we did in the training
X_test = []
...
# ------------------ storing test data values new method
X_test_2 = []
for i in range(90,inputs_2.size):
    X_test_2.append(inputs_2[i-90:i, 0])
